...
var author$project$Main$preProcessOptCodes = function (intList) {
	var array = elm$core$Array$fromList(intList);
	var twelveReplace = A3(elm$core$Array$set, 1, 12, array);
	var twoReplace = A3(elm$core$Array$set, 2, 2, twelveReplace);
	return elm$core$Array$toList(twoReplace);
};
var author$project$Main$puzzleInput = '1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,9,1,19,1,19,5,23,1,23,5,27,2,27,10,31,1,31,9,35,1,35,5,39,1,6,39,43,2,9,43,47,1,5,47,51,2,6,51,55,1,5,55,59,2,10,59,63,1,63,6,67,2,67,6,71,2,10,71,75,1,6,75,79,2,79,9,83,1,83,5,87,1,87,9,91,1,91,9,95,1,10,95,99,1,99,13,103,2,6,103,107,1,107,5,111,1,6,111,115,1,9,115,119,1,119,9,123,2,123,10,127,1,6,127,131,2,131,13,135,1,13,135,139,1,9,139,143,1,9,143,147,1,147,13,151,1,151,9,155,1,155,13,159,1,6,159,163,1,13,163,167,1,2,167,171,1,171,13,0,99,2,0,14,0';
...
var author$project$Chunk$chunkInternal = F3(
	function (pageSize, list, accumulator) {
		chunkInternal:
		while (true) {
			if (elm$core$List$isEmpty(list)) {
				return elm$core$Array$toList(accumulator);
			} else {
				var removed = A2(elm$core$List$drop, pageSize, list);
				var latest = A2(
					elm$core$Array$push,
					A2(elm$core$List$take, pageSize, list),
					accumulator);
				var $temp$pageSize = pageSize,
					$temp$list = removed,
					$temp$accumulator = latest;
				pageSize = $temp$pageSize;
				list = $temp$list;
				accumulator = $temp$accumulator;
				continue chunkInternal;
			}
		}
	});
var author$project$Chunk$chunk = F2(
	function (pageSize, list) {
		return (pageSize < 1) ? _List_fromArray(
			[list]) : A3(author$project$Chunk$chunkInternal, pageSize, list, elm$core$Array$empty);
	});
var author$project$Main$AddCode = {$: 'AddCode'};
var author$project$Main$MultiplyCode = {$: 'MultiplyCode'};
var author$project$Main$StopCode = {$: 'StopCode'};
...
var author$project$Main$detectAlgorithmFromRow = function (row) {
	var firstItemMaybe = elm$core$List$head(row);
	if (firstItemMaybe.$ === 'Just') {
		var val = firstItemMaybe.a;
		return (val === 1) ? author$project$Main$AddCode : ((val === 2) ? author$project$Main$MultiplyCode : ((val === 99) ? author$project$Main$StopCode : author$project$Main$StopCode));
	} else {
		return author$project$Main$StopCode;
	}
};
...
var author$project$Main$processAddCode = F2(
	function (rowList, opCodes) {
		var row = elm$core$Array$fromList(rowList);
		var secondPosition = A2(
			elm$core$Maybe$withDefault,
			0,
			A2(elm$core$Array$get, 2, row));
		var thirdPosition = A2(
			elm$core$Maybe$withDefault,
			0,
			A2(elm$core$Array$get, 3, row));
		var opCodeArray = elm$core$Array$fromList(opCodes);
		var value2 = A2(
			elm$core$Maybe$withDefault,
			0,
			A2(elm$core$Array$get, secondPosition, opCodeArray));
		var firstPosition = A2(
			elm$core$Maybe$withDefault,
			0,
			A2(elm$core$Array$get, 1, row));
		var value1 = A2(
			elm$core$Maybe$withDefault,
			0,
			A2(elm$core$Array$get, firstPosition, opCodeArray));
		var finalValue = value1 + value2;
...
var author$project$Main$processMultiplyCode = F2(
	function (rowList, opCodes) {
		var row = elm$core$Array$fromList(rowList);
		var secondPosition = A2(
			elm$core$Maybe$withDefault,
		...
		F2(
			function (opt, acc) {
				...
				var processed = function () {
					switch (algo.$) {
						case 'AddCode':
							return A2(author$project$Main$processAddCode, opt, acc);
						case 'MultiplyCode':
							return A2(author$project$Main$processMultiplyCode, opt, acc);
						default:
							return acc;
					}
				}();
...
var author$project$Main$processedOptCodeToString = function (list) {
	return A2(
		...
		A3(
			...
			F2(
				function (i, acc) {
					return acc + (elm$core$String$fromInt(i) + ', ');
				}),
			'',
			list));
};
var author$project$Main$processedOptCodesToString = function (list) {
	var chunked = A2(author$project$Chunk$chunk, 4, list);
	return A3(
		elm$core$List$foldl,
		F2(
			function (optCode, acc) {
				return acc + (author$project$Main$processedOptCodeToString(optCode) + ',');
			}),
		'',
		chunked);
};
...
var author$project$Main$viewIntRow = function (list) {
	var row = A2(
		elm$core$String$dropRight,
		2,
		A3(
...
var author$project$Main$viewIntRows = function (model) {
	var chunked = A2(author$project$Chunk$chunk, 4, model.intCodes);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			...
			A2(elm$core$List$map, author$project$Main$viewIntRow, chunked)));
};
...
var author$project$Material$TextArea$textArea = function (config) {
	return A3(
		...
		elm$core$List$concat(
			_List_fromArray(
				[
					config.fullwidth ? _List_fromArray(
					[
...
var author$project$Material$TextArea$textAreaConfig = {additionalAttributes: _List_Nil, cols: elm$core$Maybe$Nothing, disabled: false, fullwidth: false, label: elm$core$Maybe$Nothing, maxLength: elm$core$Maybe$Nothing, minLength: elm$core$Maybe$Nothing, onChange: elm$core$Maybe$Nothing, onInput: elm$core$Maybe$Nothing, outlined: false, placeholder: elm$core$Maybe$Nothing, required: false, rows: elm$core$Maybe$Nothing, valid: true, value: ''};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Advent of Code: Day 2')
											])),
										A2(
										elm$html$Html$div,
										_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_Utils_update(
											...
											{
												cols: elm$core$Maybe$Just(6),
												rows: elm$core$Maybe$Just(6),
												value: model.initialInput
											}))
									])),
								author$project$Main$viewIntRows(model),
								A2(
								elm$html$Html$div,
								_List_fromArray(
									[
